...
class Evaluator(object):
    def __init__(self, model, visiual=True):
        ...
        self.val_data_path = os.path.join(cfg.DATA_PATH, 'VOCtest2007', 'VOCdevkit', 'VOC2007')
    ...
    def __calc_APs(self, iou_thresh=0.5, use_07_metric=False):
        ...
        for i, cls in enumerate(self.classes):
            R, P, AP, iou = voc_eval.voc_eval(filename, annopath, imagesetfile, cls, cachedir, iou_thresh, use_07_metric)
            APs[cls] = AP
            IOUs[cls] = iou
